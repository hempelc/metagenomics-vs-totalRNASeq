...
do
	...
	if [[ $CLASSIFICATION == 'true' ]] ; then
		...
		echo -e "\n======== RUNNING CREST ========\n"
		blastn -db ~/programs/CREST/LCAClassifier/parts/flatdb/silvamod/silvamod128.fasta -query $assembly_dna_outputs -outfmt "5" -max_target_seqs 5 -num_threads 16 -out BLAST_output.xml
