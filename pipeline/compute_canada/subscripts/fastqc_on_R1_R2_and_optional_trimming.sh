...
if [[ $trimming == "yes" ]] ; then
	...
	for score in $PHRED; do
		...
		mkdir fastqc_on_R1_R2_and_optional_trimming_output/trimmomatic/trimmed_at_phred_${score}_${baseout##*/}
		...
		fastqc_on_R1_R2_and_optional_trimming_output/trimmomatic/trimmed_at_phred_${score}_${baseout##*/}
	done
fi
...
if [[ $trimming == "yes" ]] ; then
	for reads in fastqc_on_R1_R2_and_optional_trimming_output/trimmomatic/trimmed_at_phred_*${baseout##*/}/*_1P.fastq; do
		dir_name=${reads%_*} # making variable so that read names can be used to make directory
		mkdir fastqc_on_R1_R2_and_optional_trimming_output/fastqc_reports/${dir_name##*/}
		fastqc $reads -o fastqc_on_R1_R2_and_optional_trimming_output/fastqc_reports/${dir_name##*/} -t $threads
		echo -e "\n"
	done

	for reads in fastqc_on_R1_R2_and_optional_trimming_output/trimmomatic/trimmed_at_phred_*${baseout##*/}/*_2P.fastq; do
